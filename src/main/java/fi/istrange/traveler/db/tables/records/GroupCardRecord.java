...
public class GroupCardRecord extends UpdatableRecordImpl<GroupCardRecord> implements Record5<Integer, Date, Date, Long, Long> {

    private static final long serialVersionUID = 1740076270;
     ...
     */
    @Override
    public Row5<Integer, Date, Date, Long, Long> fieldsRow() {
     ...
     */
    @Override
    public Row5<Integer, Date, Date, Long, Long> valuesRow() {
     ...
     */
    @Override
    public GroupCardRecord value1(Integer value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public GroupCardRecord values(Integer value1, Date value2, Date value3, Long value4, Long value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GroupCardRecord(Integer id, Date startTime, Date endTime, Long lon, Long lat) {
        super(GroupCard.GROUP_CARD);
