...
public class GroupCardDao extends DAOImpl<GroupCardRecord, fi.istrange.traveler.db.tables.pojos.GroupCard, Integer> {
     ...
     */
    @Override
    protected Integer getId(fi.istrange.traveler.db.tables.pojos.GroupCard object) {
        return object.getId();
    }
     ...
     */
    public List<fi.istrange.traveler.db.tables.pojos.GroupCard> fetchById(Integer... values) {
     ...
     */
    public fi.istrange.traveler.db.tables.pojos.GroupCard fetchOneById(Integer value) {
